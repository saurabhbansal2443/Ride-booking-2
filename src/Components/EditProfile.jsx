...
import { User, Mail, Phone, Camera, ChevronLeft, Save, X, Edit2, Star, Car } from "lucide-react";
    ...
    <div className="max-w-md mx-auto min-h-screen bg-[#0f172a] text-slate-200 pb-10 font-sans">
      ...
      <div className="flex items-center justify-between p-5 bg-[#1e293b]/50 backdrop-blur-md sticky top-0 z-10">
        <div className="flex items-center gap-4">
          <div className="p-2 hover:bg-slate-800 rounded-full transition-colors cursor-pointer">
            <ChevronLeft size={24} className="text-slate-400" />
          </div>
          <h1 className="text-lg font-semibold tracking-wide">Profile Settings</h1>
        </div>
        <button
      ...
      <div className="relative overflow-hidden px-6 py-10 flex flex-col items-center">
        ...
        <h2 className="mt-6 text-2xl font-bold tracking-tight text-white">{name}</h2>
        ...
        <div className="flex items-center gap-3 mt-4">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800/50 rounded-full border border-slate-700/50">
            ...
            <span className="text-xs font-medium text-slate-300">4.5 Rating</span>
          </div>
        </div>
      </div>
          ...
          {!isEditing ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-widest text-slate-500 font-bold">Mobile Number</p>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) => setCurrentData({ ...currentData, phoneNumber: e.target.value })}
                  />
                </div>
              </div>
